...
```{r Directory}
file_list <- dir_ls(gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\CDM_23238\005)"),recurse = T,glob = "*extracted_realm.zip|*events.csv|*readings.csv")
```
